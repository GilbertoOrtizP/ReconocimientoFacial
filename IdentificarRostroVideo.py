...
image = cv2.imread("ImagenesRostros/Leonardo DiCaprio/Imagen1.jpg")
image = cv2.cvtColor(image, cv2.COLOR_BGR2RGB)
face_loc3=face_recognition.face_locations(image)
vector_rostro3 = face_recognition.face_encodings(image, known_face_locations=[face_loc3][0])
vector_rostro3=vector_rostro3[0]
...
while True:
    ...
    if face_loc2 != []:
        for face_loc2 in face_loc2:
            ...
            comp1 = face_recognition.compare_faces([vector_rostro1],vector_rostro2)
            comp2 = face_recognition.compare_faces([vector_rostro3],vector_rostro2)
            ...
            if comp2[0]==True:
                text="Leo DiCaprio"
                color=(255,0,0)
            if (comp1[0]==False) and (comp2[0]==False):
                text="Desconocido"
                color=(50,50,255)
